...
HD_PWD='/home/jacob/Documents/ECE2700/4BitProcessor/4BitProcessor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessorTop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ProcessorTop.tcl
